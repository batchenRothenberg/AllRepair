...
class Z3SubsetSolver:
	...
	print "total cons:" , len(self.constraints), "total hard+soft:" , len(self.soft_constraints)+len(self.hard_constraints)
	#print(self.sizes)
	#print(self.n)
	...
	for idx, (group,cons_i) in enumerate(self.soft_constraints):
		...
		print("soft cons. from group " + str(group)+ " with index " + str(cons_i) + "is out of range for constraints array")
