...
public:
  ...
  typedef std::list<exprt> expr_listt; //bat
  ...
  void apply_mutations(OutputIterator it, std::string& mutation_level) const;
  template<typename OutputIterator>
  void apply_mutations_aux(OutputIterator it, exprt& curr,std::string& mutation_level);
  template<typename OutputIterator>
  void apply_operator_mutations(OutputIterator it, exprt& curr, std::string& mutation_level);
  template<typename OutputIterator>
  void replace_operator(OutputIterator it, dstring new_op) const;
  template<typename OutputIterator>
  void save_mutated_expr(OutputIterator it) const;
};

typedef std::list<exprt> expr_listt;
typedef std::vector<exprt> expr_vectort; //bat
