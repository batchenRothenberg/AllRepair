...
void cbmc_parse_optionst::get_command_line_options(optionst &options)
{
  ...
  if(cmdline.isset("mutations"))
      options.set_option("mutations", cmdline.get_value("mutations")); //bat

  if(cmdline.isset("no-mut"))
      options.set_option("no-mut", cmdline.get_value("no-mut")); //bat
