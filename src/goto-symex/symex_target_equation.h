...
public:
  ...
  void convert(prop_convt &prop_conv, const optionst &options); //bat added options
  void convert_assignments(decision_proceduret &decision_procedure) const;
  void convert_assignments(decision_proceduret &decision_procedure, const optionst &options); //bat removed const
